...
import BallenoImage from "../../assets/images/louis-vitton-1.jpeg";
import Image37 from "../../assets/images/louis-vitton-2.jpeg";
import WhiteDarkImage from "../../assets/images/louis-vitton-3.jpeg";
  ...
  const authCards = [
    {
      ...
      description:
        "Louis Vuitton treats stitching as an art form with strict stitch counts.",
      features: [
    ...
    },
    {
      ...
      description:
        "LV monogram alignment is one of the quickest giveaways of authenticity.",
      features: [

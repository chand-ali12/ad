  ...
  const authCards = [
    {
      ...
      description:
        "Gucci does not use traditional serial numbers. Instead, authentic bags have a two-row style code.",
      features: [
    ...
    },
    {
      ...
      description:
        "Authentic Gucci hardware is solid, weighty, and precisely engraved.",
      features: [
    ...
    },
    {
      ...
      description:
        "Gucci invests heavily in premium materials for all their pieces.",
      features: [

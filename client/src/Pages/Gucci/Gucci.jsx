    ...
    const authCards = [
        {
            ...
            description: "Gucci does not use traditional serial numbers. Instead, authentic bags have a two-row style code.",
            features: [
                "Top row: 6-digit model/style number",
                "Bottom row: 4–6 digit production/batch code",
                "Clean, crisp embossing with no letters or symbols",
                "Located under the GUCCI / made in italy / ®️ stamp"
            ],
        ...
        },
        {
            ...
            description: "Authentic Gucci hardware is solid, weighty, and precisely engraved.",
            features: [
                "Sharp, modern sans-serif engraving",
                "Smooth edges and even depth",
                "Consistent plating with no peeling or bubbling",
                "Proper engravings on zipper pulls, GG emblems, clasps"
            ],
            buttonText: "View Details",
            bottomLeftIcon: Eye,
            showPopularTag: false,
        },
        {
            ...
            title: "3. Materials: Leather, Canvas & Lining",
            description: "Gucci invests heavily in premium materials for all their pieces.",
            features: [
                "Leather: Soft, supple, natural-looking, no plastic shine",
                "GG Supreme Canvas: Symmetrical pattern, neutral taupe/beige",
                "Smooth, lightly coated finish—not overly glossy",
                "Authentic linings feel premium, never cheap or thin"
            ],
            buttonText: "View Details",
    ...
    const guideItems = [
        {
            ...
            content: [
                "Structured shape and strong edges",
        ...
        },
        {
            ...
            content: [
                ...
                "Bad stitching is one of the quickest red flags"
            ]
        },
        {
            title: "3. Logo, Fonts & Heat Stamps",
            content: [
                "\"GUCCI\" in uppercase",
                "\"made in italy\" beneath",
                "Properly placed ®️ symbol",
                "Crisp, clear, evenly pressed embossing",
                "Style code on reverse side—never mixed with branding"
            ]
        },
        {
            ...
            content: [
                ...
                "Genuine straps feel high-quality and structured"
            ]
        },
        {
            title: "5. Use Online Tools for Quick Verification",
            content: [
                "Fast Gucci authenticity check online for instant peace of mind",
                "Photo-based authentication can be helpful",
                "Accuracy depends on image quality and reviewer's skill",
                "Great for initial screening before professional verification"
            ]
        },
        {
        ...
        {
            title: "7. Confidence Comes From Knowledge",
            content: [

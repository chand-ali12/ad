            ...
            <div className="prices-body">
              ...
              <div className="prices-rows">
                <div className="prices-cell">
                  <BrandBlock
                    brand={leftColumnBrands[0]}
                    activeTab={activeTab}
                  />
                </div>
                <div className="prices-cell">
                  <BrandBlock
                    brand={rightColumnBrands[0]}
                    activeTab={activeTab}
                  />
                </div>
                <div className="prices-cell">
                  <BrandBlock
                    brand={leftColumnBrands[1]}
                    activeTab={activeTab}
                  />
                </div>
                <div className="prices-cell">
                  <BrandBlock
                    brand={rightColumnBrands[1]}
                    activeTab={activeTab}
                  />
                  <BrandBlock
                    brand={rightColumnBrands[2]}
                    activeTab={activeTab}
                  />
                </div>
              </div>

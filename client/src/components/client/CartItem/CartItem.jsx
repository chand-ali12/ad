        ...
        <div className="flex-grow">
          <div className="mb-1">
            <span className="text-xs sm:text-sm text-gray-500 font-semibold">
              Brand :{" "}
              <span className="font-normal">{brand?.trim() ? brand : "—"}</span>
            </span>
          </div>
          <div>
            <span className="text-xs sm:text-sm text-gray-500 font-semibold">
              Model{" "}
              <span className="font-normal">{model?.trim() ? model : "—"}</span>
            </span>
            {/* <div className="text-sm sm:text-base font-semibold text-black"></div> */}
          </div>
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <div className="flex items-center gap-1 border border-gray-300 rounded-lg">
              <button
                type="button"
                onClick={() =>
                  onQuantityChange(Math.max(1, (quantity || 1) - 1))
                }

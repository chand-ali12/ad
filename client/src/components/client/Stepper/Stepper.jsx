...
const Stepper = ({
  ...
  const lineColorClass = lineColor === "secondary" ? "bg-secondary" : "bg-line-color";
    ...
    <div className={`flex flex-col relative overflow-visible ${className}`}>
      ...
      <div className="flex items-start gap-3 md:hidden">
        ...
        <div className="flex-1 min-w-0 pt-1">
          {heading && (
            <h3 className={`text-sm font-bold text-primary mb-1 ${headingClassName}`}>
              {heading}
            </h3>
          )}
          ...
          {subHeading && (
            <p className={`text-xs leading-relaxed text-primary opacity-70 mt-1 ${subHeadingClassName}`}>
              {subHeading}
            </p>
          )}
        </div>
      ...
      <div className="hidden md:flex md:flex-col md:items-center md:w-full overflow-visible">
        ...
        <div className="flex flex-col items-center text-center mt-3 sm:mt-4 w-full px-1">
          {heading && (
            <h3
              className={`text-sm sm:text-base md:text-lg lg:text-xl font-bold mb-1.5 sm:mb-2 text-primary ${headingClassName}`}
            >
              {heading}
            </h3>
          )}
          {subHeading && (
            <p
              className={`text-xs sm:text-sm leading-relaxed text-primary opacity-70 max-w-[200px] ${subHeadingClassName}`}
            >
              {subHeading}
            </p>
          )}

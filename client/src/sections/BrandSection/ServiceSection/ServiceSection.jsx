...
const ServiceSection = ({
  ...
  return (
    <section className={`w-full py-8 sm:py-12 md:py-16 lg:py-24 bg-primary ${className}`}>
              ...
              {card.content && card.content.length > 0 && (
                <ul className="space-y-3 sm:space-y-4 list-none">
                  {card.content.map((paragraph, pIndex) => (
                    ...
                    >
                      <span className="text-primary text-lg sm:text-xl leading-none mt-1 flex-shrink-0">•</span>
                      <span>{paragraph}</span>
                    </li>
                  ))}
                </ul>

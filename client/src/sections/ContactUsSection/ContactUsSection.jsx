...
const ContactUsSection = ({ className = "" }) => {
    return (
        <section className={`relative w-full min-h-[700px] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 ${className}`}>
            {/* Background Image */}
            ...
            <div className="relative z-10 bg-white px-6 py-5 sm:px-8 sm:py-6 rounded-xl shadow-lg text-center">
                <p className="text-primary text-base sm:text-lg md:text-xl font-normal" style={{ fontFamily: 'Montserrat, system-ui, Avenir, Helvetica, Arial, sans-serif' }}>
